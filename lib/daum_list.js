...
var iconv  = require('iconv-lite');
  ...
  function getdata(page, category, callback){
    var url = "http://media.daum.net/breakingnews/"+category+"?page="+page.toString()
    console.log(url);
  ...
  var getalldata =function(page,pagelimit,category,callback){
      getdata(page,category,function(data){
        ...
        if (page >=pagelimit){
          ...
          getalldata(page+1,pagelimit,category,callback);
        }
      })
  }

  var daum_list = function(pagelimit,category,callback){
    big = {}
    var page =1
